    ...
    <>
      ...
      >
        ...
        >
          ...
          <Select placeholder="Selecione uma kit escolar" focusBorderColor="green.500">
            <option value="option1">Kit 1</option>
            <option value="option2">Kit 2</option>
            <option value="option3">Kit 3</option>
          </Select>
